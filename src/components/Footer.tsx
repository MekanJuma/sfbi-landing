    ...
    <footer className="bg-white border-t border-gray-200 pt-12 pb-8">
      <div className="container-custom">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          <div>
            <h4 className="text-lg font-bold mb-4">Force Analytics</h4>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/documentation" className="text-text-secondary hover:text-primary">
                  Documentation
                </Link>
              </li>
              <li>
                <Link href="/guide" className="text-text-secondary hover:text-primary">
                  User Guide
                </Link>
              </li>
              <li>
                <Link href="/api" className="text-text-secondary hover:text-primary">
                  API Reference
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/security" className="text-text-secondary hover:text-primary">
                  Security
                </Link>
              </li>
              <li>
                <Link href="/compliance" className="text-text-secondary hover:text-primary">
                  Compliance
                </Link>
              </li>
            </ul>
        ...
        <div className="pt-8 border-t border-gray-200 flex flex-col md:flex-row justify-between items-center">
          <p className="text-text-secondary text-sm">
            &copy; {currentYear} Force Analytics. All rights reserved.
          </p>
